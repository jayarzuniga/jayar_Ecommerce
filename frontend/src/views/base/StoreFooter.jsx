    ...
    return (
        <footer className="bg-light text-center text-lg-start" style={{ marginTop: 200 }}>
            <div className="container p-4">
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex justify-content-center justify-content-md-end">
                        <a className="btn btn-primary btn-sm btn-floating me-2" style={{ backgroundColor: "#3b5998" }} href="#!" role="button">
                            <i className="fab fa-facebook-f" />
                        </a>
                        <a className="btn text-white btn-sm btn-floating me-2" style={{ backgroundColor: "#55acee" }} href="#!" role="button">
                            <i className="fab fa-twitter" />
                        </a>
                        <a className="btn text-white btn-sm btn-floating me-2" style={{ backgroundColor: "#c61118" }} href="#!" role="button">
                            <i className="fab fa-pinterest" />
                        </a>
                        <a className="btn text-white btn-sm btn-floating me-2" style={{ backgroundColor: "#ed302f" }} href="#!" role="button">
                            <i className="fab fa-youtube" />
                        </a>
                        <a className="btn text-white btn-sm btn-floating me-2" style={{ backgroundColor: "#ac2bac" }} href="#!" role="button">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 mb-4 mb-lg-0">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><a href="#!" className="text-dark">Fashion</a></li>
                            <li><a href="#!" className="text-dark">Beauty</a></li>
                            <li><a href="#!" className="text-dark">Automotive</a></li>
                        </ul>
                    </div>
                    <div className="col-lg-2 mb-4 mb-lg-0">
                        <p><strong>Support</strong></p>
                        <ul className="list-unstyled">
                            <li><a href="#!" className="text-dark">Complaints</a></li>
            ...
            <div className="text-center p-3" style={{ backgroundColor: "rgba(0, 0, 0, 0.2)" }}>
                © 2024 - Date Copyright:
                <a className="text-dark" href="https://mdbootstrap.com/">MyShop</a>
            </div>
        </footer>
    );
}
